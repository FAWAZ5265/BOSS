...
if not msg.SudoBase then return "📛*¦* هذا الامر يخص {المطور الاساسي} فقط  \n🚶" end
local GetVerison = https.request('https://TFT9T.github.io/GetVersion.txt') or 0
...
local Get_Files, res = https.request("https://raw.githubusercontent.com/TFT9T/TFT9T.github.io/master/plugins/"..FileName)
if res == 200 then
