...
download_file('https://raw.githubusercontent.com/FAWAZ8297/BOSS/master/inc/Run.lua','./inc/Run.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'40% - |█████       |') end
download_file('https://raw.githubusercontent.com/FAWAZ8297/BOSS/master/inc/locks.lua','./inc/locks.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'60% - |███████     |') end
download_file('https://raw.githubusercontent.com/FAWAZ8297/BOSS/master/inc/Script.lua','./inc/Script.lua')
if edit then EditMsg(msg.chat_id_,msg.id_,'80% - |█████████   |') end
download_file('https://raw.githubusercontent.com/FAWAZ8297/BOSS/master/inc/functions.lua','./inc/functions.lua')
...
usernn = data.username_ or "TFT9T"
else 
Name = data.title_
usernn = data.type_.user_.username_ or "TFT9T"
end
Name = Name:gsub('[[][]]','')
